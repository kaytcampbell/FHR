    ...
    */
    public function displayErrors() {
      ...
      foreach($this->errors as $value) {
        $errorsList .= "<li class=\"errors\">". $value . "</li>\n";
      }
      $errorsList .= "</ul>\n";
      return $errorsList;
    }// end displayErrors
    ...
    */
    public function errorNumMessage() {
      if(count($this->errors) > 1) {
              $message = "<span class=\"errors\">There were " . count($this->errors) . " errors sending your message!</span>\n";
          } else {
              $message = "<span class=\"errors\">There was an error sending your message!</span>\n";
          }
      return $message;
    }// end hasErrors
